...
pub const KEYMAP: [[KeyDef; NUM_COLS]; NUM_ROWS] = [
    ...
    // Row 4: LCtrl   LGui    LAlt    Space   Space   Space   Space   Space   RGui    Fn      RCtrl   Left    Down    Right
    [m(0x01), m(0x08), m(0x04), k(0x2C), k(0x2C), k(0x2C), k(0x2C), k(0x2C), m(0x80), __,     m(0x10), k(0x50), k(0x51), k(0x4F)],
];
